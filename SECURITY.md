...
coordinate remediation and disclosure with the reporter. Please avoid
accessing data that is not yours, disrupting services, or exploiting a finding
beyond what is necessary to demonstrate it.

The current backend threat model and publication risks are documented in
[`docs/security/backend-threat-model.md`](docs/security/backend-threat-model.md).
