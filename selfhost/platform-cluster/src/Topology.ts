...
/**
 * Cluster services every platform-cluster adapter needs in context.
 *
 ...
 *
 * This is the default self-host topology: one runner owns every shard, while
 ...
 */
export const TestClusterLive: Layer.Layer<
  ClusterTopology | MessageStorage.MemoryDriver
> = TestRunner.layer;
