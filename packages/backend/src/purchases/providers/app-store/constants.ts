/**
 * Apple root CA certificates used to anchor the JWS signature chain on App
 * Store payloads. Stored as base64-encoded DER (multi-line). For consumers
 * that expect PEM strings (e.g. `@voidhash/app-store-server-sdk`'s
 * `SignedDataVerifier`), use {@link APPLE_ROOT_CERTIFICATES_PEM}.
 */
export const APPLE_ROOT_CERTIFICATE =
...
UKqK1drk/NAJBzewdXUh`.trim();

export const APPLE_ROOT_CA_G2 = `MIIFkjCCA3qgAwIBAgIIAeDltYNno+AwDQYJKoZIhvcNAQEMBQAwZzEbMBkGA1UE
...
um1xRKtzCTrJ+VKACd+66eYWyi4uTLLT3OUEVLLUNIAytbwPF+E=`.trim();

export const APPLE_ROOT_CA_G3 = `MIICQzCCAcmgAwIBAgIILcX8iNLFS5UwCgYIKoZIzj0EAwMwZzEbMBkGA1UEAwwS
...
/** Apple root CAs in PEM format. */
export const APPLE_ROOT_CERTIFICATES_PEM: ReadonlyArray<string> = [
  toPem(APPLE_ROOT_CERTIFICATE),
  toPem(APPLE_ROOT_CA_G2),
  toPem(APPLE_ROOT_CA_G3),
];
