...
const protectedResourceMetadata = Effect.fn("protectedResourceMetadata")(function* () {
...
const authorizationServerMetadata = Effect.fn("authorizationServerMetadata")(function* () {
  const mcpOAuth = yield* McpOAuth;
...
const registerMcpOAuthRoutes = Effect.fn("registerMcpOAuthRoutes")(function* () {
