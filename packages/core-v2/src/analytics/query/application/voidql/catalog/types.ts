/**
 * The virtual-schema catalog model. Users write SQL against *logical* tables
...
/** Capabilities resolved once per query from the authorized principal. */
 ...
 * the key is **bound**, never escaped.
 */
...
export interface CatalogTable {
   ...
   * `organization_id`/`project_id` predicate inline, wrapping the
   * deduplication and identity machinery. The only producer of physical table
   * identity.
   */
