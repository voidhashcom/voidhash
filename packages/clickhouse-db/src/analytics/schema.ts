...
export const CLICKHOUSE_EVENTS_TABLE = "events_v2" as const;
export const CLICKHOUSE_PERSONS_TABLE = "persons_v1" as const;
export const CLICKHOUSE_PERSON_IDENTITY_TABLE = "person_identity_v1" as const;
export const CLICKHOUSE_PERSON_IDENTITY_OVERRIDES_TABLE = "person_identity_overrides_v1" as const;
