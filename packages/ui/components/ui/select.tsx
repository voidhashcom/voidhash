    ...
    <SelectPrimitive.Portal>
      ...
      >
        ...
        <SelectPrimitive.Viewport
          ...
          className="p-1 data-[position=popper]:w-full data-[position=popper]:min-w-[var(--radix-select-trigger-width)]"
        >
          {children}
        </SelectPrimitive.Viewport>
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "focus:bg-primary focus:text-accent-foreground focus:**:text-accent-foreground gap-1.5 rounded-md py-1 pr-8 pl-1.5 text-sm [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2 relative flex w-full cursor-default items-center outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 transition-none",
        className,
      )}
      {...props}
    >
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      className={cn(
        "bg-popover/70 text-muted-foreground z-10 flex cursor-default items-center justify-center py-1 backdrop-blur-md [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
      {...props}
    >
