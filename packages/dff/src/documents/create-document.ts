...
//   TNodes extends Record<string, z.ZodObject<any>>
// > {
...
//  * ```
//  */
// export function createDocument<TNodes extends Record<string, z.ZodObject<any>>>(
//   config: CreateDocumentConfig<TNodes>
// ): DocumentDefinition<TNodes> {
