/**
 * The supported VoidQL query corpus, shared by the compile-only unit suite and
 * the live-ClickHouse integration suite so both prove the same surface.
 */
...
export const CAPABILITIES = new Set<Capability>(["pii"]);
...
export const SUPPORTED_QUERIES: readonly SupportedQuery[] = [
  {
