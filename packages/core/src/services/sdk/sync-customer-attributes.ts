...
export interface CustomerAttributesParams {
  name?: string;
  email?: string;
  customerMetadata: CustomerMetadata;
}

export const syncCustomerAttributes = Effect.gen(
  function* syncCustomerAttributes() {
    const db = yield* Db;
    const customerService = yield* CustomerService;
    return Effect.fn("syncCustomerAttributes")(
      function* syncCustomerAttributes(input: CustomerAttributesParams) {
