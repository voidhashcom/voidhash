...
export const invoiceTaxMinor = (invoice: StripeInvoice): number => {
...
export const isPaidOneTimeCheckout = (session: StripeCheckoutSession): boolean =>
...
export const chargeStorefront = (charge: StripeCharge): string | undefined =>
