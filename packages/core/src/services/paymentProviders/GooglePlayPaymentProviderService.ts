...
import { GooglePlayPaymentProviderServiceError } from "./googlePlay/errors.ts";

/**
 * Re-exported so routes and `SdkService` can import the single canonical error
 * class from the boundary (avoiding the App Store's dual-class trap).
 */
 ...
 * processing.
 */
export interface GooglePlaySdkTransactionResult {
