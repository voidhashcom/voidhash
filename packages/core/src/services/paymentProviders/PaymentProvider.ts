...
import type { PaymentProviderConfigurationValidationError } from "../../domain/paymentProvider/PaymentProviderConfiguration.ts";
import type { PaymentProviderProductValidationError } from "../../domain/paymentProvider/PaymentProviderProduct.ts";
