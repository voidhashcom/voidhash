...
export const updatePaymentProviderProduct = Effect.gen(
  function* updatePaymentProviderProduct() {
    const db = yield* Db;
    return Effect.fn("updatePaymentProviderProduct")(
      function* updatePaymentProviderProduct(input: {
        id: string;
        ...
        return yield* db.transaction((tx) =>
          TransactionContext.provide(tx)(
            Effect.gen(function* updatePaymentProviderProduct() {
