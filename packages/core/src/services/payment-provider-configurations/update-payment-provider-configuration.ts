...
export const updatePaymentProviderConfiguration = Effect.gen(
  function* updatePaymentProviderConfiguration() {
    const db = yield* Db;
    return Effect.fn("updatePaymentProviderConfiguration")(
      function* updatePaymentProviderConfiguration(input: {
        id: string;
        enabled: boolean;
        name?: string;
        configuration: Record<string, unknown>;
        ...
        const existingConfiguration =
          yield* _getPaymentProviderConfigurationById(db)(input.id);
