...
export const deletePaymentProviderConfiguration = Effect.gen(
  function* deletePaymentProviderConfiguration() {
    const db = yield* Db;
    return Effect.fn("deletePaymentProviderConfiguration")(
      function* deletePaymentProviderConfiguration(input: {
