...
export const getPaymentProviderConfigurations = Effect.gen(
  function* getPaymentProviderConfigurations() {
    const db = yield* Db;
    return Effect.fn("getPaymentProviderConfigurations")(
      function* getPaymentProviderConfigurations(projectId: string) {
        ...
        return yield* _getPaymentProviderConfigurationsByProjectId(db)(
          projectId
        );
      },
      (effect) =>
