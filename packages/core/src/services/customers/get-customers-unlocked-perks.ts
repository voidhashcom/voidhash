import { customerUnlockedPerks, customers, eq } from "@voidhash/db";
...
export const getCustomersUnlockedPerks = Effect.gen(
  function* getCustomersUnlockedPerks() {
    const db = yield* Db;
    return Effect.fn("getCustomersUnlockedPerks")(
      function* getCustomersUnlockedPerks(customerId: string) {
