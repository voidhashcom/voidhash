 ...
 */
export const SubscriptionTransferModeSchema = Schema.Literals([
  "transfer_to_new_owner",
  "keep_with_previous_owner",
  "transfer_if_no_active_on_target",
]);

export type SubscriptionTransferMode = typeof SubscriptionTransferModeSchema.Type;
 ...
 */
export const DEFAULT_SUBSCRIPTION_TRANSFER_MODE: SubscriptionTransferMode = "transfer_to_new_owner";
