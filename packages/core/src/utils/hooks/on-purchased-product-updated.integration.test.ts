...
// 		let perks = await h.db.primary.query.customerUnlockedPerks.findMany({
// 			where: eq(
// 				customerUnlockedPerks.unlockedByPurchaseId,
...
// 		perks = await h.db.primary.query.customerUnlockedPerks.findMany({
// 			where: eq(
// 				customerUnlockedPerks.unlockedByPurchaseId,
// 				initialCustomerProduct.value.id
// 			),
