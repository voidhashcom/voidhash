...
export type NotificationsSendNotification500 =
  | ApiAuthenticationErrorJsonEncoding
...
export type PerksListPerks500 =
  | ApiPerkServiceErrorJsonEncoding
  | ApiAuthenticationErrorJsonEncoding;
...
export type SdkDevelopmentPurchaseParamsXSdk = "react-native" | "web";
...
export type UsersGetUser500 =
  | ApiAuthenticationErrorJsonEncoding
  | ApiUserServiceErrorJsonEncoding
  | ApiAuthenticationErrorJsonEncoding;
...
export type PaymentProviderConfigurationsListPaymentProviderConfigurations200 =
  ReadonlyArray<PaymentProviderConfigurationJsonEncoding>;
...
export type PaymentProviderProductsListPaymentProviderProducts200 =
  ReadonlyArray<PaymentProviderProductJsonEncoding>;
  ...
  return {
    ...
    authSession: () =>
      HttpClientRequest.get(`/api/v1/auth/session`).pipe(
        onRequest(["2xx"], {
          ...
          "500": "ApiAuthenticationErrorJsonEncoding",
        }),
      ),
    apiKeysListApiKeys: () =>
    ...
    personsCreatePerson: (options) =>
      HttpClientRequest.post(`/api/v1/persons`).pipe(
        HttpClientRequest.bodyJsonUnsafe(options),
        onRequest(["2xx"], {
          "400": "ApiPersonInvalidAnonymousIdErrorJsonEncoding",
          "401": "ApiNotAuthenticatedErrorJsonEncoding",
          "403": "ApiActionForbiddenErrorJsonEncoding",
    ...
    notificationsSendNotification: (options) =>
      HttpClientRequest.post(`/api/v1/notifications/send`).pipe(
        ...
        onRequest(["2xx"], {
          ...
          "500": "NotificationsSendNotification500",
        }),
      ),
...
export interface VoidhashCoreClient {
  ...
  readonly personsCreatePerson: (
    options: CreatePersonBodyJsonEncoding,
  ) => Effect.Effect<
    PersonJsonEncoding,
    | HttpClientError.HttpClientError
    | VoidhashCoreClientError<
        "ApiPersonInvalidAnonymousIdErrorJsonEncoding",
        ApiPersonInvalidAnonymousIdErrorJsonEncoding
      >
    | VoidhashCoreClientError<
        "ApiNotAuthenticatedErrorJsonEncoding",
  ...
  readonly notificationsSendNotification: (
    ...
    | VoidhashCoreClientError<
        ...
        ApiPushSendNotEnabledErrorJsonEncoding
      >
    | VoidhashCoreClientError<"NotificationsSendNotification500", NotificationsSendNotification500>
  >;
  ...
  readonly webhooksUpdateWebhookEndpoint: (
    endpointId: string,
    options: UpdateWebhookEndpointBodyJsonEncoding,
  ) => Effect.Effect<
    WebhookEndpointJsonEncoding,
    | HttpClientError.HttpClientError
    | VoidhashCoreClientError<
