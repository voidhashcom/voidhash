 ...
 * standalone (single root user) provider. Other editions provide the same
 * contract through their server auth composition without forking shared
 * routes.
 *
...
import { clearedStandaloneSessionCookie, readStandaloneSession } from "../lib/standalone-session";
