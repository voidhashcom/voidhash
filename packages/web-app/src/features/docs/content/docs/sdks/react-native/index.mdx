...
The fastest way to gate a feature. See [Check access](/entitlements) for offline behavior:
...
[access checks fail open offline](/entitlements#offline-and-failure-behavior). The SDK refreshes
