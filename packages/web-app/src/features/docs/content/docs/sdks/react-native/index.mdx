...
See [Report and restore purchases](/sdks/react-native/purchases) for callback examples, error
...
storage package is needed. The cached copy survives up to two days, which is why [access checks fail open offline](/sdks/react-native/entitlements#offline-and-failure-behavior).
