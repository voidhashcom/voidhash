...
<Callout type="info" title="When to push your schema">
  Push your schema whenever you make changes to products, perks, or payment provider configuration.
  During development, you can work with an empty providers configuration to test your paywall
