...
Use the HTTP API for server integrations and custom tooling. Mobile apps should use one of the
[mobile SDKs](/sdks), which handle device headers, identity, caching, and store transactions.
