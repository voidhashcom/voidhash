 ...
 * `ownerLabel` is set for variables declared on an ancestor node (rendered as
 * secondary "from …" text by selector UIs).
 */
...
export interface StateManagerSheetProps {
  ...
  onUpdateStateCondition: (stateId: string, newCondition: DnfInput) => void;
}
