 ...
 */
export function useEditingState({ existingStateNames, onUpdateStateName }: UseEditingStateOptions) {
  ...
  const save = useCallback(() => {
    ...
    if (existingStateNames.has(trimmedName) && trimmedName !== editingState.originalName) {
