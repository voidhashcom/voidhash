...
export function ActiveTrialsChartWidget() {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="font-semibold text-muted-foreground text-sm">Active Trials</CardTitle>
        <div className="mt-1 font-semibold text-lg leading-none sm:text-2xl">70</div>
        <div className="mt-2 text-muted-foreground text-sm">65 previous period</div>
      </CardHeader>
      <CardContent>
