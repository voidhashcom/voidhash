...
export function NewUsersChartWidget() {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="font-semibold text-muted-foreground text-sm">New Users</CardTitle>
        <div className="mt-1 font-semibold text-lg leading-none sm:text-2xl">200</div>
        <div className="mt-2 text-muted-foreground text-sm">250 previous period</div>
      </CardHeader>
      <CardContent>
