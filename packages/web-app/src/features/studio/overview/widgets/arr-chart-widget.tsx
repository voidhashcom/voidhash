...
export function ARRChartWidget() {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="font-semibold text-muted-foreground text-sm">ARR</CardTitle>
        <div className="mt-1 font-semibold text-lg leading-none sm:text-2xl">$256,800</div>
        <div className="mt-2 text-muted-foreground text-sm">$250,800 previous period</div>
      </CardHeader>
      <CardContent>
