...
import { createPerkOptions, queryKeys } from "@/features/studio/lib/tanstack-query";
        ...
        <Form {...form}>
          <form className="space-y-4 pt-4" onSubmit={form.handleSubmit(onSubmit)}>
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="space-y-1">
                  ...
                  <FormControl>
                    <Input placeholder="All-Access, AI-features, etc." {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <DialogFooter className="flex sm:justify-between gap-2">
              ...
              <Button disabled={createPerkStatus === "pending"} type="submit">
                {createPerkStatus === "pending" ? "Creating Perk..." : "Create Perk"}
              </Button>
            </DialogFooter>
          </form>
        </Form>
