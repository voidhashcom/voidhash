    ...
    <Card className="mx-auto w-full max-w-5xl text-center">
      <CardHeader>
        ...
        <CardDescription className="mx-auto max-w-md text-balance">
          Each product may unlock one or more perks for the person, which your app uses to grant
          access to various features. Examples of perks include &quot;Full-Access&quot;,
          &quot;AI-features&quot;, and &quot;Premium-recipes&quot;.
        </CardDescription>
      </CardHeader>
      <CardContent>
        <CreatePerkModal
