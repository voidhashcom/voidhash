...
// 				where: and(
// 					eq(customerUnlockedPerks.customerId, testCustomerId),
// 					eq(customerUnlockedPerks.unlockedByPurchaseId, result.value.id)
// 				),
// 			});
...
// 				.where(eq(customerUnlockedPerks.customerId, testCustomerId));
// 			await h.db.primary
// 				.delete(customers)
