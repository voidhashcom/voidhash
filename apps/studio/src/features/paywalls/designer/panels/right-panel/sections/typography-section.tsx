...
import { SelectInput } from "@/features/paywalls/designer/components/ui/select-input";
import {
  PanelToggleGroup,
...
export interface TypographySectionProps extends NodeEditorProps<TypographyPropertyNames> {}
