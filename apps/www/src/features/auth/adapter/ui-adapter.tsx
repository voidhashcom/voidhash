 ...
 *
 * Companion to `session-adapter.ts`: the screens and the browser credential
 * that differ per identity provider. A private composition replaces this module
 * through a build alias to supply a richer set of screens (OAuth, passwords,
 * email verification); the open-source default offers the single standalone
 * sign-in screen and reports the rest as unavailable.
 *
