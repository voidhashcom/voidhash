...
import { Card, CardContent, CardHeader } from "@voidhash/ui";
import { InputGroup, InputGroupAddon, InputGroupInput } from "@voidhash/ui";
import { Item, ItemContent, ItemDescription, ItemGroup, ItemMedia, ItemTitle } from "@voidhash/ui";
    ...
    <Card>
      <CardHeader>
        <div className="flex items-center justify-between gap-3">
          ...
          <ToggleGroup type="single" defaultValue="etfs" spacing={1}>
