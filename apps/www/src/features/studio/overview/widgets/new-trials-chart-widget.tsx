...
export function NewTrialsChartWidget() {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="font-semibold text-muted-foreground text-sm">New Trials</CardTitle>
        <div className="mt-1 font-semibold text-lg leading-none sm:text-2xl">50</div>
        <div className="mt-2 text-muted-foreground text-sm">45 previous period</div>
      </CardHeader>
      <CardContent>
