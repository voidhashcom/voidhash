...
export function ARPPUChartWidget() {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="font-semibold text-muted-foreground text-sm">ARPPU</CardTitle>
        <div className="mt-1 font-semibold text-lg leading-none sm:text-2xl">$21.40</div>
        <div className="mt-2 text-muted-foreground text-sm">$20.80 previous period</div>
      </CardHeader>
      <CardContent>
