...
export const groupCoreClient = (client: VoidhashCoreClient) => ({
  ...
  paywallDeploys: {
    ...
    uploadBlob: (request: { params: Parameters<VoidhashCoreClient["paywallDeploysUploadBlob"]>[0]; payload: Parameters<VoidhashCoreClient["paywallDeploysUploadBlob"]>[1] }) => client.paywallDeploysUploadBlob(request.params, request.payload),
  },
  paywallLocations: {
