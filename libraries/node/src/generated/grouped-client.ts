...
export const groupCoreClient = (client: VoidhashCoreClient) => ({
  ...
  persons: {
    ...
    getPersonByDistinctId: (request: { params: { readonly distinctId: string } }) =>
  ...
  productPerks: {
    listProductPerksByProductId: (request: { params: { readonly productId: string } }) =>
      client.productPerksListProductPerksByProductId(request.params["productId"]),
  },
  products: {
  ...
  projects: {
    ...
    listProjects: (request: { params: { readonly organizationId: string } }) =>
      client.projectsListProjects(request.params["organizationId"]),
  },
  schema: {
  ...
  webhooks: {
    ...
    deleteWebhookEndpoint: (request: { params: { readonly endpointId: string } }) =>
      client.webhooksDeleteWebhookEndpoint(request.params["endpointId"]),
    getWebhookDelivery: (request: { params: { readonly deliveryId: string } }) =>
      client.webhooksGetWebhookDelivery(request.params["deliveryId"]),
    getWebhookEndpoint: (request: { params: { readonly endpointId: string } }) =>
    ...
    retryWebhookDelivery: (request: { params: { readonly deliveryId: string } }) =>
      client.webhooksRetryWebhookDelivery(request.params["deliveryId"]),
    rotateWebhookSecret: (request: { params: { readonly endpointId: string } }) =>
      client.webhooksRotateWebhookSecret(request.params["endpointId"]),
    testWebhookEndpoint: (request: { params: { readonly endpointId: string } }) =>
    ...
    updateWebhookEndpoint: (request: {
      ...
      payload: Parameters<VoidhashCoreClient["webhooksUpdateWebhookEndpoint"]>[1];
    }) => client.webhooksUpdateWebhookEndpoint(request.params["endpointId"], request.payload),
  },
});
