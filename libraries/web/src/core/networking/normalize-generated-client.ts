...
const normalizeRequest = (
  ...
  Effect.gen(function* normalizeRequestEffect() {
...
// biome-ignore lint/suspicious/noExplicitAny: Generic client normalization requires dynamic typing
export const normalizeGeneratedClient = <T extends Record<string, any>>(
  client: T
): T =>
  Object.fromEntries(
