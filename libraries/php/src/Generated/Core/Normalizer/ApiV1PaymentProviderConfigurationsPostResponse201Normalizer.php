...
class ApiV1PaymentProviderConfigurationsPostResponse201Normalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Voidhash\Generated\Core\Model\ApiV1PaymentProviderConfigurationsPostResponse201::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Voidhash\Generated\Core\Model\ApiV1PaymentProviderConfigurationsPostResponse201::class;
    }
    public function denormalize(mixed $data, string $type, ?string $format = null, array $context = []): mixed
    {
        $object = new \Voidhash\Generated\Core\Model\ApiV1PaymentProviderConfigurationsPostResponse201();
    ...
    {
        return [\Voidhash\Generated\Core\Model\ApiV1PaymentProviderConfigurationsPostResponse201::class => false];
    }
}