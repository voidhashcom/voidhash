...
On iOS, restore calls `AppStore.sync()` and reads verified non-consumable transaction history;
this may prompt for App Store authentication. Android queries currently owned Play purchases.
