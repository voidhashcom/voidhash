...
namespace margelo::nitro::voidhash {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/voidhash/PaywallWebViewSource;";
  ...
  public:
    ...
    static jni::local_ref<JPaywallWebViewSource::javaobject> fromCpp(const PaywallWebViewSource& value) {
      using JSignature = JPaywallWebViewSource(jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JArrayClass<JPaywallWebViewHeader>>, jni::alias_ref<jni::JString>, jni::alias_ref<jni::JString>);
      static const auto clazz = javaClassStatic();
      ...
      return create(
        ...
        value.headers.has_value() ? [&]() {
          ...
          for (size_t __i = 0; __i < __size; __i++) {
            ...
            auto __elementJni = JPaywallWebViewHeader::fromCpp(__element);
