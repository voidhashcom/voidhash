...
namespace margelo::nitro::voidhash {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/voidhash/Func_void;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/voidhash/Func_void_cxx;";
