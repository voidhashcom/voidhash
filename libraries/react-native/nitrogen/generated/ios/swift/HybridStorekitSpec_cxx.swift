...
open class HybridStorekitSpec_cxx {
   ...
   */
  @inline(__always)
  public func equals(other: HybridStorekitSpec_cxx) -> Bool {
  ...
  @inline(__always)
  public final func syncStore() -> bridge.Result_std__shared_ptr_Promise_void___ {
    do {
      let __result = try self.__implementation.syncStore()
